        ...
        <>
          ...
          <div className='mb-6'>
            ...
            <p className='text-black dark:text-gray-200/80 text-base'>
              Experienced in semantic HTML structure, screen readers, and in
              writing code that is WCAG 2.1 compliant.
            </p>
          </div>
          <div className='mb-6'>
            <h3 className='text-black dark:text-gray-200 text-lg font-medium flex mb-2'>
            ...
            <p className='text-black dark:text-gray-200/80 text-base'>
              Projects that look good on all devices and all browsers. If it
              doesn't work on mobile, then it doesn't work.
            </p>
          </div>
          <div className='mb-6'>
            <h3 className='text-black dark:text-gray-200 text-lg font-medium flex mb-2'>
            ...
            <p className='text-black dark:text-gray-200/80 text-base'>
              A keen eye for design, and skilled with Adobe Photoshop,
          ...
          <div className='mb-6'>
            ...
            <p className='text-black dark:text-gray-200/80 text-base'>
              Experienced working onsite and remotely in cross-disceplanary
              teams. Excellent communication skills.
            </p>
          </div>
          <div className='mb-6'>
            <h3 className='text-black dark:text-gray-200 text-lg font-medium flex mb-2'>
            ...
            <p className='text-black dark:text-gray-200/80 text-base'>
              A self-taught developer who isn't afraid of a challenge and loves
              to attack problems head on. Always learning new things.
            </p>
          </div>
        </>
      )}
